...
FrameResourceController::FrameResourceController(ID3D12Device* device, UINT passCount, UINT objectCount, UINT waveVertCount) :
	device { device },
	passCount { passCount },
	objectCount { objectCount }
{
	...
	{
		frameResources.push_back(std::make_unique<FrameResource>(device, passCount, objectCount, waveVertCount));
	}
