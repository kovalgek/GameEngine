...
{
	shaders["standardVS"] = d3dUtil::compileShader(L"resources\\shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	shaders["opaquePS"] = d3dUtil::compileShader(L"resources\\shaders\\Default.hlsl", nullptr, "PS", "ps_5_0");
