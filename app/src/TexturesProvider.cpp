...
std::unique_ptr<Texture> TexturesProvider::waterTexture()
{
	...
	waterTex->Filename = L"resources/textures/water1.dds";
	ThrowIfFailed(CreateDDSTextureFromFile12(
		device,
		commandList,
...
std::unique_ptr<Texture> TexturesProvider::fenceTexture()
{
	...
	fenceTex->Filename = L"resources/textures/WoodCrate01.dds";
	ThrowIfFailed(CreateDDSTextureFromFile12(
		device,
		commandList,
...
std::unique_ptr<Texture> TexturesProvider::white1x1Texture()
{
	...
	white1x1Tex->Filename = L"resources/textures/white1x1.dds";
	ThrowIfFailed(CreateDDSTextureFromFile12(
		device,
		commandList,
